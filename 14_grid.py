...
btn_5.grid(row=1, column=1, sticky=N+E+W+S, padx=3, pady=3)
btn_6.grid(row=1, column=2, sticky=N+E+W+S, padx=3, pady=3)
...
btn_enter.grid(row=3, column=3, sticky=N+E+W+S, padx=3, pady=3)
...
btn_enter.grid(row=4, column=3, rowspan=2, sticky=N+E+W+S, padx=3, pady=3) # rowspan : 현재 위치로 부터 아래쪽으로 합침

btn_0 = Button(root, text='0', padx=10, pady=10)
btn_point = Button(root, text='.', padx=10, pady=10)

btn_0.grid(row=5, column=0, columnspan=2, sticky=N+E+W+S, padx=3, pady=3) # columspan : 현재 위치로부터 오른쪽으로 합침
